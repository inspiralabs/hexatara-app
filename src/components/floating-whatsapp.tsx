...
export async function FloatingWhatsapp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-40 flex size-14 items-center justify-center rounded-full bg-emerald-600 text-white shadow-float [transition:var(--transition-hover)] hover:bg-emerald-700 hover:shadow-float-hover"
    >
