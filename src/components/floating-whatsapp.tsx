...
export async function FloatingWhatsapp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-40 flex size-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-float [transition:var(--transition-hover)] hover:bg-primary/90 hover:shadow-float-hover"
    >
